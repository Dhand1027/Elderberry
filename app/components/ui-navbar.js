  ...
  render() {
    return (
      <nav className="navbar navbar-default navbar-fixed-top">
        ...
        <ul className="nav navbar-nav navbar-right" style="margin-top:10px;">
          <li className="dropdown"><a href="#" claclassNamess="dropdown-toggle" data-toggle="dropdown">Welcome, User <b className="caret"></b></a>
